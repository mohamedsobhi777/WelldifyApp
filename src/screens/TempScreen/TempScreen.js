...
const SplashScreen = () => {
    const [UserProfileModalVisible, setUserProfileModalVisible] = useState();
    return (
        <>
...
const Header = ({ setUserProfileModalVisible }) => {
    return (
        <View style={styles.header}>
            <Pressable onPress={() => setUserProfileModalVisible(true)}>
